...
public class CallbackInjector extends Injector {
      ...
      if (this.localCapture.isPrintLocals()) {
         ...
         if (!var1.checkDescriptor(this.methodNode.desc)) {
            ...
            if (var1.canCaptureLocals) {
               MethodNode var5 = Bytecode.findMethod(this.classNode, this.methodNode.name, var1.getDescriptor());
               if (var5 != null && Annotations.getVisible(var5, Surrogate.class) != null) {
                  var2 = var5;
               } else {
                  String var6 = this.generateBadLVTMessage(var1);
                  switch(this.localCapture) {
                  case CAPTURE_FAILEXCEPTION:
                     Injector.logger.error("Injection error: {}", new Object[]{var6});
                     var2 = this.generateErrorMethod(var1, "org/spongepowered/asm/mixin/injection/throwables/InjectionError", var6);
                     break;
                  case CAPTURE_FAILSOFT:
                     Injector.logger.warn("Injection warning: {}", new Object[]{var6});
                     return;
                  default:
                     Injector.logger.error("Critical injection failure: {}", new Object[]{var6});
                     throw new InjectionError(var6);
                  }
               }
            } else {
               String var3 = this.methodNode.desc.replace("Lorg/spongepowered/asm/mixin/injection/callback/CallbackInfo;", "Lorg/spongepowered/asm/mixin/injection/callback/CallbackInfoReturnable;");
               if (var1.checkDescriptor(var3)) {
                  throw new InvalidInjectionException(this.info, "Invalid descriptor on " + this.info + "! CallbackInfoReturnable is required!");
               }

               MethodNode var4 = Bytecode.findMethod(this.classNode, this.methodNode.name, var1.getDescriptor());
               if (var4 == null || Annotations.getVisible(var4, Surrogate.class) == null) {
   ...
   private static List<String> summariseLocals(Type[] var0, int var1) {
   ...
   private class Callback extends InsnList {
      ...
      Callback(MethodNode var2, Target var3, InjectionNodes.InjectionNode var4, LocalVariableNode[] var5, boolean var6) {
         ...
         this.frameSize = Bytecode.getFirstNonArgLocalIndex(var3.arguments, !CallbackInjector.this.isStatic());
         ArrayList var7 = null;
         if (var5 != null) {
            int var8 = CallbackInjector.this.isStatic() ? 0 : 1;
            var7 = new ArrayList();
