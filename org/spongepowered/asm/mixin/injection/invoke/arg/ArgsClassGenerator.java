...
public final class ArgsClassGenerator implements IClassGenerator {
   ...
   public String getClassName(String var1) {
      String var2 = Bytecode.changeDescriptorReturnType(var1, "V");
      String var3 = (String)this.classNames.get(var2);
      if (var3 == null) {
         var3 = String.format("%s%d", "org.spongepowered.asm.synthetic.args.Args$", this.nextIndex++);
         this.classNames.put(var2, var3);
      }
