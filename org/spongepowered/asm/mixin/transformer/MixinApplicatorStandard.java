...
class MixinApplicatorStandard {
   ...
   MixinApplicatorStandard(TargetClassContext var1) {
      ...
      ExtensionClassExporter var2 = (ExtensionClassExporter)var1.getExtensions().getExtension(ExtensionClassExporter.class);
      this.mergeSignatures = var2.isDecompilerActive() && MixinEnvironment.getCurrentEnvironment().getOption(MixinEnvironment.Option.DEBUG_EXPORT_DECOMPILE_MERGESIGNATURES);
   }
   ...
   protected void mergeNewFields(MixinTargetContext var1) {
      ...
      while(var2.hasNext()) {
         ...
         if (var4 == null) {
            ...
            if (var3.signature != null) {
               if (this.mergeSignatures) {
                  SignatureVisitor var5 = var1.getSignature().getRemapper();
                  (new SignatureReader(var3.signature)).accept(var5);
                  var3.signature = var5.toString();
               } else {
                  var3.signature = null;
               }
            }
   ...
   private MixinApplicatorStandard.Range getConstructorRange(MethodNode var1) {
      ...
      return new MixinApplicatorStandard.Range(var5, var6, var7);
   }

   protected final Deque<AbstractInsnNode> getInitialiser(MixinTargetContext var1, MethodNode var2) {
   ...
   class Range {
      ...
      Range(int var2, int var3, int var4) {
         this.start = var2;
         this.end = var3;
         this.marker = var4;
      }
