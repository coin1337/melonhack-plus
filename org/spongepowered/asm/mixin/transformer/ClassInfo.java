...
public final class ClassInfo {
   ...
   private ClassInfo(ClassNode var1) {
      ...
      try {
         ...
         FieldNode var6;
         for(Iterator var5 = var1.fields.iterator(); var5.hasNext(); this.fields.add(new ClassInfo.Field(var6, this.isMixin))) {
   ...
   private void addMethod(MethodNode var1, boolean var2) {
      if (!var1.name.startsWith("<")) {
         this.methods.add(new ClassInfo.Method(var1, var2));
      }
   ...
   public Set<ClassInfo.Method> getInterfaceMethods(boolean var1) {
   ...
   private <M extends ClassInfo.Member> M findInHierarchy(String var1, String var2, ClassInfo.SearchType var3, ClassInfo.Traversal var4, int var5, ClassInfo.Member.Type var6) {
      Iterator var8;
      ...
      if (var6 == ClassInfo.Member.Type.METHOD && (this.isInterface || MixinEnvironment.getCompatibilityLevel().supportsMethodsInInterfaces())) {
         ...
         while(var8.hasNext()) {
            ...
            if (var15 == null) {
               ...
               if (var11 != null) {
                  return (ClassInfo.Member)(this.isInterface ? var11 : new ClassInfo.InterfaceMethod(var11));
               }
            }
         }
      }
   ...
   private <M extends ClassInfo.Member> M cloneMember(M var1) {
      return (ClassInfo.Member)(var1 instanceof ClassInfo.Method ? new ClassInfo.Method(var1) : new ClassInfo.Field(var1));
   }
   ...
   private <M extends ClassInfo.Member> M findMember(String var1, String var2, int var3, ClassInfo.Member.Type var4) {
   ...
   class Field extends ClassInfo.Member {
      public Field(ClassInfo.Member var2) {
         super(var2);
      }

      public Field(FieldNode var2) {
         this(var2, false);
      }

      public Field(FieldNode var2, boolean var3) {
      ...
      public Field(String var2, String var3, int var4) {
         super(ClassInfo.Member.Type.FIELD, var2, var3, var4, false);
      }

      public Field(String var2, String var3, int var4, boolean var5) {
   ...
   public class InterfaceMethod extends ClassInfo.Method {
      ...
      public InterfaceMethod(ClassInfo.Member var2) {
         super((ClassInfo.Member)var2);
   ...
   public class Method extends ClassInfo.Member {
      ...
      public Method(String var2, String var3, int var4) {
         super(ClassInfo.Member.Type.METHOD, var2, var3, var4, false);
         this.frames = null;
      }

      public Method(String var2, String var3, int var4, boolean var5) {
