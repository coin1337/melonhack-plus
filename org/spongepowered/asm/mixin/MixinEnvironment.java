...
public final class MixinEnvironment implements ITokenProvider {
   ...
   MixinEnvironment(MixinEnvironment.Phase var1) {
      ...
      if (var2 != null && "0.7.11".equals(var2)) {
   ...
   static class MixinLogWatcher {
      ...
      static void begin() {
         Logger var0 = LogManager.getLogger("FML");
         if (var0 instanceof org.apache.logging.log4j.core.Logger) {
            log = (org.apache.logging.log4j.core.Logger)var0;
