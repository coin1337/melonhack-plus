...
public class Analyzer<V extends Value> implements Opcodes {
   ...
   public Frame<V>[] analyze(String var1, MethodNode var2) throws AnalyzerException {
   ...
   private void findSubroutine(int var1, Subroutine var2, List<AbstractInsnNode> var3) throws AnalyzerException {
   ...
   private void merge(int var1, Frame<V> var2, Subroutine var3) throws AnalyzerException {
   ...
   private void merge(int var1, Frame<V> var2, Frame<V> var3, Subroutine var4, boolean[] var5) throws AnalyzerException {
