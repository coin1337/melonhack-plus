...
public abstract class MixinValidator implements IMixinValidator {
   ...
   public final boolean validate(IMixinValidator.ValidationPass var1, TypeElement var2, AnnotationHandle var3, Collection<TypeHandle> var4) {
   ...
   protected final Collection<TypeMirror> getMixinsTargeting(TypeMirror var1) {
