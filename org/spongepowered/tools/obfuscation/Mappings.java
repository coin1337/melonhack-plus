...
class Mappings implements IMappingConsumer {
   ...
   static class UniqueMappings implements IMappingConsumer {
      ...
      private <TMapping extends IMapping<TMapping>> boolean checkForExistingMapping(ObfuscationType var1, TMapping var2, TMapping var3, Map<ObfuscationType, Map<TMapping, TMapping>> var4) throws Mappings.MappingConflictException {
