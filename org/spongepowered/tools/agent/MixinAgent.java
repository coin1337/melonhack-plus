         ...
         if (var3 == null) {
            ...
            if (var6 != null) {
               ...
               try {
                  ...
                  return MixinAgent.this.classTransformer.transformClassBytes((String)null, var2, var5);
      ...
      private boolean reApplyMixins(List<String> var1) {
         ...
         while(var3.hasNext()) {
            ...
            try {
               ...
               var7 = MixinAgent.this.classTransformer.transformClassBytes((String)null, var5, var7);
