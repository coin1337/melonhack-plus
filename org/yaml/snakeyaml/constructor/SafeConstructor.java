...
public class SafeConstructor extends BaseConstructor {
   ...
   private List<NodeTuple> mergeNode(MappingNode var1, boolean var2, Map<Object, Integer> var3, List<NodeTuple> var4) {
   ...
   public class ConstructYamlMap implements Construct {
      public Object construct(Node var1) {
         return var1.isTwoStepsConstruction() ? SafeConstructor.this.createDefaultMap() : SafeConstructor.this.constructMapping((MappingNode)var1);
      }

      public void construct2ndStep(Node var1, Object var2) {
         if (var1.isTwoStepsConstruction()) {
            SafeConstructor.this.constructMapping2ndStep((MappingNode)var1, (Map)var2);
         } else {
   ...
   public class ConstructYamlSeq implements Construct {
      public Object construct(Node var1) {
         ...
         return var1.isTwoStepsConstruction() ? SafeConstructor.this.newList(var2) : SafeConstructor.this.constructSequence(var2);
      }

      public void construct2ndStep(Node var1, Object var2) {
         if (var1.isTwoStepsConstruction()) {
            SafeConstructor.this.constructSequenceStep2((SequenceNode)var1, (List)var2);
         } else {
   ...
   public class ConstructYamlStr extends AbstractConstruct {
      public Object construct(Node var1) {
         return SafeConstructor.this.constructScalar((ScalarNode)var1);
      }
   }
   ...
   public class ConstructYamlSet implements Construct {
      public Object construct(Node var1) {
         if (var1.isTwoStepsConstruction()) {
            return SafeConstructor.this.constructedObjects.containsKey(var1) ? SafeConstructor.this.constructedObjects.get(var1) : SafeConstructor.this.createDefaultSet();
         } else {
            return SafeConstructor.this.constructSet((MappingNode)var1);
         }
      }

      public void construct2ndStep(Node var1, Object var2) {
         if (var1.isTwoStepsConstruction()) {
            SafeConstructor.this.constructSet2ndStep((MappingNode)var1, (Set)var2);
         } else {
      ...
      public Object construct(Node var1) {
         if (!(var1 instanceof SequenceNode)) {
            ...
            while(var4.hasNext()) {
               ...
               Object var9 = SafeConstructor.this.constructObject(var7);
               Object var10 = SafeConstructor.this.constructObject(var8);
   ...
   public class ConstructYamlBinary extends AbstractConstruct {
      public Object construct(Node var1) {
         String var2 = SafeConstructor.this.constructScalar((ScalarNode)var1).toString().replaceAll("\\s", "");
   ...
   public class ConstructYamlFloat extends AbstractConstruct {
      public Object construct(Node var1) {
         String var2 = SafeConstructor.this.constructScalar((ScalarNode)var1).toString().replaceAll("_", "");
         byte var3 = 1;
   ...
   public class ConstructYamlInt extends AbstractConstruct {
      public Object construct(Node var1) {
         ...
         if ("0".equals(var2)) {
            ...
            if (var2.startsWith("0b")) {
               ...
               if (!var2.startsWith("0")) {
                  if (var2.indexOf(58) == -1) {
                     return SafeConstructor.this.createNumber(var3, var2, 10);
                  }
                  ...
                  return SafeConstructor.this.createNumber(var3, String.valueOf(var8), 10);
               }
            ...
            return SafeConstructor.this.createNumber(var3, var2, var11);
         }
      }
   }
   ...
   public class ConstructYamlBool extends AbstractConstruct {
      public Object construct(Node var1) {
         String var2 = (String)SafeConstructor.this.constructScalar((ScalarNode)var1);
   ...
   public class ConstructYamlNull extends AbstractConstruct {
      public Object construct(Node var1) {
         SafeConstructor.this.constructScalar((ScalarNode)var1);
         return null;
      }
   }
}
