...
public class Constructor extends SafeConstructor {
   ...
   public Constructor(Class<? extends Object> var1) {
   ...
   public Constructor(TypeDescription var1, Collection<TypeDescription> var2) {
      if (var1 == null) {
   ...
   protected class ConstructSequence implements Construct {
      public Object construct(Node var1) {
         ...
         if (Set.class.isAssignableFrom(var1.getType())) {
            ...
            return var1.isTwoStepsConstruction() ? Constructor.this.createArray(var1.getType(), var2.getValue().size()) : Constructor.this.constructArray(var2);
         } else {
            ...
            if (!var3.isEmpty()) {
               ...
               if (var3.size() == 1) {
                  ...
                  Node var20;
                  for(var18 = var2.getValue().iterator(); var18.hasNext(); var15[var6++] = Constructor.this.constructObject(var20)) {
      ...
      private final Class<? extends Object> wrapIfPrimitive(Class<?> var1) {
         if (!var1.isPrimitive()) {
            return var1;
   ...
   protected class ConstructScalar extends AbstractConstruct {
      public Object construct(Node var1) {
         ...
         try {
            return Constructor.this.newInstance(var3, var2, false);
            ...
            if (!var3.isPrimitive() && var3 != String.class && !Number.class.isAssignableFrom(var3) && var3 != Boolean.class && !Date.class.isAssignableFrom(var3) && var3 != Character.class && var3 != BigInteger.class && var3 != BigDecimal.class && !Enum.class.isAssignableFrom(var3) && !Tag.BINARY.equals(var2.getTag()) && !Calendar.class.isAssignableFrom(var3) && var3 != UUID.class) {
               ...
               if (var7 == null) {
                  try {
                     ...
                     throw new YAMLException("No single argument constructor found for " + var3 + " : " + var12.getMessage());
                  }
               }
               ...
               if (var6 == 1) {
                  ...
                  var16 = Constructor.this.constructScalar(var2);
               ...
               try {
                  ...
                  throw new ConstructorException((String)null, (Mark)null, "Can't construct a java object for scalar " + var2.getTag() + "; exception=" + var13.getMessage(), var2.getStartMark(), var13);
               }
            } else {
      ...
      private Object constructStandardJavaInstance(Class var1, ScalarNode var2) {
         ...
         if (var1 == String.class) {
            var4 = (Construct)Constructor.this.yamlConstructors.get(Tag.STR);
            ...
            if (var1 != Character.class && var1 != Character.TYPE) {
               if (Date.class.isAssignableFrom(var1)) {
                  var4 = (Construct)Constructor.this.yamlConstructors.get(Tag.TIMESTAMP);
                  ...
                  if (var1 != Byte.class && var1 != Short.class && var1 != Integer.class && var1 != Long.class && var1 != BigInteger.class && var1 != Byte.TYPE && var1 != Short.TYPE && var1 != Integer.TYPE && var1 != Long.TYPE) {
                     if (Enum.class.isAssignableFrom(var1)) {
                        ...
                        SafeConstructor.ConstructYamlFloat var13 = Constructor.this.new ConstructYamlFloat();
                        ...
                        var3 = ((Construct)Constructor.this.yamlConstructors.get(var2.getTag())).construct(var2);
                     }
                  } else {
                     var4 = (Construct)Constructor.this.yamlConstructors.get(Tag.INT);
                     var3 = var4.construct(var2);
                  ...
                  var4 = (Construct)Constructor.this.yamlConstructors.get(Tag.FLOAT);
                  var3 = var4.construct(var2);
            ...
            var4 = (Construct)Constructor.this.yamlConstructors.get(Tag.BOOL);
            var3 = var4.construct(var2);
         }
   ...
   protected class ConstructYamlObject implements Construct {
      private Construct getConstructor(Node var1) {
         ...
         var1.setType(var2);
         Construct var3 = (Construct)Constructor.this.yamlClassConstructors.get(var1.getNodeId());
         return var3;
      }
   ...
   protected class ConstructMapping implements Construct {
      ...
      public void construct2ndStep(Node var1, Object var2) {
         if (Map.class.isAssignableFrom(var1.getType())) {
            Constructor.this.constructMapping2ndStep((MappingNode)var1, (Map)var2);
         } else if (Set.class.isAssignableFrom(var1.getType())) {
            Constructor.this.constructSet2ndStep((MappingNode)var1, (Set)var2);
         } else {
      ...
      protected Object constructJavaBean2ndStep(MappingNode var1, Object var2) {
         Constructor.this.flattenMapping(var1);
         ...
         while(var5.hasNext()) {
            ...
            String var9 = (String)Constructor.this.constructObject(var7);

            try {
               TypeDescription var10 = (TypeDescription)Constructor.this.typeDefinitions.get(var3);
               ...
               Object var18 = var10 != null ? this.newInstance(var10, var9, var8) : Constructor.this.constructObject(var8);
