...
class SafeRepresenter extends BaseRepresenter {
   ...
   public SafeRepresenter() {
      ...
      SafeRepresenter.RepresentPrimitiveArray var1 = new SafeRepresenter.RepresentPrimitiveArray();
   ...
   protected class RepresentByteArray implements Represent {
      public Node representData(Object var1) {
         ...
         return SafeRepresenter.this.representScalar(Tag.BINARY, String.valueOf(var2), '|');
      }
   }
   ...
   protected class RepresentDate implements Represent {
      public Node representData(Object var1) {
         ...
         return SafeRepresenter.this.representScalar(SafeRepresenter.this.getTag(var1.getClass(), Tag.TIMESTAMP), var10.toString(), (Character)null);
      }
   }
   ...
   protected class RepresentSet implements Represent {
      public Node representData(Object var1) {
         ...
         return SafeRepresenter.this.representMapping(SafeRepresenter.this.getTag(var1.getClass(), Tag.SET), var2, (Boolean)null);
      }
   }

   protected class RepresentMap implements Represent {
      public Node representData(Object var1) {
         return SafeRepresenter.this.representMapping(SafeRepresenter.this.getTag(var1.getClass(), Tag.MAP), (Map)var1, (Boolean)null);
      }
   }
   ...
   protected class RepresentPrimitiveArray implements Represent {
      public Node representData(Object var1) {
         ...
         if (Byte.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asByteList(var1), (Boolean)null);
         } else if (Short.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asShortList(var1), (Boolean)null);
         } else if (Integer.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asIntList(var1), (Boolean)null);
         } else if (Long.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asLongList(var1), (Boolean)null);
         } else if (Float.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asFloatList(var1), (Boolean)null);
         } else if (Double.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asDoubleList(var1), (Boolean)null);
         } else if (Character.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asCharList(var1), (Boolean)null);
         } else if (Boolean.TYPE == var2) {
            return SafeRepresenter.this.representSequence(Tag.SEQ, this.asBooleanList(var1), (Boolean)null);
         } else {
   ...
   protected class RepresentArray implements Represent {
      public Node representData(Object var1) {
         ...
         return SafeRepresenter.this.representSequence(Tag.SEQ, var3, (Boolean)null);
      }
   }
   ...
   protected class RepresentIterator implements Represent {
      public Node representData(Object var1) {
         ...
         return SafeRepresenter.this.representSequence(SafeRepresenter.this.getTag(var1.getClass(), Tag.SEQ), new SafeRepresenter.IteratorWrapper(var2), (Boolean)null);
      }
   }

   protected class RepresentList implements Represent {
      public Node representData(Object var1) {
         return SafeRepresenter.this.representSequence(SafeRepresenter.this.getTag(var1.getClass(), Tag.SEQ), (List)var1, (Boolean)null);
      }
   }
   ...
   protected class RepresentString implements Represent {
      public Node representData(Object var1) {
         ...
         if (SafeRepresenter.this.defaultScalarStyle == null && SafeRepresenter.MULTILINE_PATTERN.matcher(var4).find()) {
            var3 = '|';
         }
