   ...
   private class ExpectDocumentStart implements EmitterState {
      ...
      public void expect() throws IOException {
         if (Emitter.this.event instanceof DocumentStartEvent) {
            ...
            boolean var9 = this.first && !var1.getExplicit() && !Emitter.this.canonical && var1.getVersion() == null && (var1.getTags() == null || var1.getTags().isEmpty()) && !Emitter.this.checkEmptyDocument();
            if (!var9) {
               Emitter.this.writeIndent();
               Emitter.this.writeIndicator("---", true, false, false);
               if (Emitter.this.canonical) {
