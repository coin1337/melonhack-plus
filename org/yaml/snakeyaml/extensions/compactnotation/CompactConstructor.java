...
public class CompactConstructor extends Constructor {
   ...
   protected void setProperties(Object var1, Map<String, Object> var2) throws Exception {
      if (var2 == null) {
   ...
   public class ConstructCompactObject extends Constructor.ConstructMapping {
      ...
      public void construct2ndStep(Node var1, Object var2) {
         ...
         if (var5 instanceof MappingNode) {
            ...
            CompactConstructor.this.applySequence(var2, CompactConstructor.this.constructSequence((SequenceNode)var5));
         }
      ...
      public Object construct(Node var1) {
         ...
         CompactData var5 = CompactConstructor.this.getCompactData(var2.getValue());
         return var5 == null ? CompactConstructor.this.constructScalar(var2) : CompactConstructor.this.constructCompactFormat(var2, var5);
      }
   }
}
