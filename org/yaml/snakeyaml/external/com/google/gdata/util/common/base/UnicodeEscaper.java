...
public abstract class UnicodeEscaper implements Escaper {
   ...
   public Appendable escape(final Appendable var1) {
      ...
      return new Appendable() {
         ...
         public Appendable append(CharSequence var1x, int var2, int var3) throws IOException {
            int var4 = var2;
            if (var2 < var3) {
               int var5 = var2;
               char[] var7;
               if (this.pendingHighSurrogate != -1) {
                  var4 = var2 + 1;
                  char var6 = var1x.charAt(var2);
                  if (!Character.isLowSurrogate(var6)) {
                     throw new IllegalArgumentException("Expected low surrogate character but got " + var6);
                  }

                  var7 = UnicodeEscaper.this.escape(Character.toCodePoint((char)this.pendingHighSurrogate, var6));
                  if (var7 != null) {
               ...
               while(true) {
                  ...
                  int var9 = UnicodeEscaper.codePointAt(var1x, var4, var3);
                  if (var9 < 0) {
                     this.pendingHighSurrogate = -var9;
                     break;
                  }

                  var7 = UnicodeEscaper.this.escape(var9);
                  if (var7 != null) {
                     this.outputChars(var7, var7.length);
                  } else {
         ...
         public Appendable append(char var1x) throws IOException {
            ...
            if (this.pendingHighSurrogate != -1) {
               ...
               var2 = UnicodeEscaper.this.escape(Character.toCodePoint((char)this.pendingHighSurrogate, var1x));
               if (var2 != null) {
               ...
               var2 = UnicodeEscaper.this.escape(var1x);
               if (var2 != null) {
                  this.outputChars(var2, var2.length);
               } else {
                  var1.append(var1x);
         ...
         private void outputChars(char[] var1x, int var2) throws IOException {
